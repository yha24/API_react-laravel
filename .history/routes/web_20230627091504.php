...
//Wishlist
Route::get('wishlist/{id}', [App\Http\Controllers\WishlistController::class,'WishlistShow']) ->name ('WishlistShow');

Route::get('wishlist-count/{id}', [App\Http\Controllers\WishlistController::class,'WishlistShowCount']) ->name ('WishlistShowCount');